...
Namespace DateRange
    ...
    Public Class MyGridView
        ...
        Public Overloads ReadOnly Property Columns As MyGridColumnCollection
            Get
                Return TryCast(MyBase.Columns, MyGridColumnCollection)
            End Get
        End Property

        Protected Overrides Function CreateDateFilterPopup(ByVal column As GridColumn, ByVal ownerControl As Windows.Forms.Control, ByVal creator As Object) As DateFilterPopup
